...
public class LBViewPager extends ViewPager {
    ...
    private LBViewPageAdapter mAdapter;
    private boolean isCanScroll = true;
    private boolean canLoop = true;

    public void setAdapter(LBViewPageAdapter adapter, boolean canLoop) {
        mAdapter = adapter;
    ...
    public LBViewPageAdapter getAdapter() {
        return mAdapter;
    }
    ...
    public LBViewPager(Context context) {
        super(context);
        init();
    }

    public LBViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
