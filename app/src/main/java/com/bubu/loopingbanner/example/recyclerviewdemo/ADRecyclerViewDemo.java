package com.bubu.loopingbanner.example.recyclerviewdemo;
...
import com.bubu.loopingbanner.example.R;
...
public class ADRecyclerViewDemo extends Activity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private LoopingBanner loopingBanner;
    ...
    private void initViews() {
        ...
        loopingBanner = (LoopingBanner) LayoutInflater.from(this).inflate(R.layout.adapter_header_cb, null);
        loopingBanner.setLayoutParams(new RecyclerView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 600));
...
//                .setPageIndicator(new int[]{R.mipmap.ic_page_indicator, R.mipmap.ic_page_indicator_focused});
        ...
        adapter.addHeader(loopingBanner);
        loadTestDatas();
    }
